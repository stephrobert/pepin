...
la qualité d'une détection ; « 91 verdicts prouvés sur 455 » dit où en est le
...
|---|---|---:|---:|---:|
| `fail` | une configuration vulnérable est détectée | 137 | 23 | 16 |
| `pass` | une configuration réellement correcte est confirmée | 137 | 35 | 25 |
